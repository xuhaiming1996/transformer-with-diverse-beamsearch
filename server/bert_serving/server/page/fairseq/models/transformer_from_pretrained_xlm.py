...
from bert_serving.server.page.fairseq import checkpoint_utils
from bert_serving.server.page.fairseq.data.legacy.masked_lm_dictionary import MaskedLMDictionary
from bert_serving.server.page.fairseq.models import register_model, register_model_architecture
from bert_serving.server.page.fairseq.models.transformer import (
    TransformerDecoder,
    TransformerEncoder,
    TransformerModel,
