...
from bert_serving.server.page.fairseq.models import (
    FairseqMultiModel,
    register_model,
...
class MultilingualTransformerModel(FairseqMultiModel):
    ...
    def build_model(cls, args, task):
        ...
        from bert_serving.server.page.fairseq.tasks.multilingual_translation import MultilingualTranslationTask
