...
from bert_serving.server.page.fairseq.modules import TransformerSentenceEncoderLayer
from bert_serving.server.page.fairseq.modules.sparse_multihead_attention import SparseMultiheadAttention
