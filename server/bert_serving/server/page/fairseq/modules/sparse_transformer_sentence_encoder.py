...
from bert_serving.server.page.fairseq.modules import TransformerSentenceEncoder
from bert_serving.server.page.fairseq.modules.sparse_transformer_sentence_encoder_layer import SparseTransformerSentenceEncoderLayer
