...
from bert_serving.server.page.fairseq.models import FairseqEncoder, FairseqDecoder


def save_checkpoint(args, trainer, epoch_itr, val_loss):
    from bert_serving.server.page.fairseq import distributed_utils, meters
...
def load_model_ensemble_and_task(filenames, arg_overrides=None, task=None):
    from bert_serving.server.page.fairseq import tasks
...
def _upgrade_state_dict(state):
    ...
    from bert_serving.server.page.fairseq import models, registry, tasks
