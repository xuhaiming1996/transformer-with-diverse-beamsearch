...
from bert_serving.server.page.fairseq.data import FairseqDataset, data_utils
...
from bert_serving.server.page.fairseq.data.token_block_dataset import TokenBlockDataset
from bert_serving.server.page.fairseq.data.concat_dataset import ConcatDataset
