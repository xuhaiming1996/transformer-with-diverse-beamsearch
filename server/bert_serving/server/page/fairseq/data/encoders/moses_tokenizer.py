...
from bert_serving.server.page.fairseq.data.encoders import register_tokenizer
...
class MosesTokenizer(object):
    ...
    def __init__(self, args):
        ...
        try:
            ...
            print("这里提醒分词语言：",args.moses_source_lang)
            print("这里提醒分词语言：", args.moses_target_lang)
