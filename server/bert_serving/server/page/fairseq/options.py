...
from bert_serving.server.page.fairseq import utils
from bert_serving.server.page.fairseq.data.indexed_dataset import get_available_dataset_impl
...
def get_generation_parser(interactive=False, default_task='translation'):
    ...
    if interactive:
        print("interactiveinteractiveinteractiveinteractiveinteractive")
...
def parse_args_and_arch(parser, input_args=None, parse_known=False, suppress_defaults=False):
    ...
    from bert_serving.server.page.fairseq.models import ARCH_MODEL_REGISTRY, ARCH_CONFIG_REGISTRY
    # print(ARCH_MODEL_REGISTRY)
    # print(ARCH_CONFIG_REGISTRY)
    ...
    from bert_serving.server.page.fairseq.registry import REGISTRIES

    print("进入.....")

    for registry_name, REGISTRY in REGISTRIES.items():
        print("registry_name:",registry_name)
    ...
    if hasattr(args, 'task'):
        from bert_serving.server.page.fairseq.tasks import TASK_REGISTRY
        print("tasks:", args.task)
        TASK_REGISTRY[args.task].add_args(parser)
    if getattr(args, 'use_bmuf', False):
        # hack to support extra args for block distributed data parallelism
        from bert_serving.server.page.fairseq.optim.bmuf import FairseqBMUF
...
def get_parser(desc, default_task='translation'):
    ...
    from bert_serving.server.page.fairseq.tasks import TASK_REGISTRY
    print("TASK_REGISTRY.keys:",TASK_REGISTRY.keys())
...
def add_model_args(parser):
    ...
    from bert_serving.server.page.fairseq.models import ARCH_MODEL_REGISTRY
