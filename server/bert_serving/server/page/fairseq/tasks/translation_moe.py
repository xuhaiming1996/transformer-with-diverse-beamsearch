...
from bert_serving.server.page.fairseq import modules, utils
from bert_serving.server.page.fairseq.tasks import register_task
from bert_serving.server.page.fairseq.tasks.translation import TranslationTask
