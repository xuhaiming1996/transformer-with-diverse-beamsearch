...
from bert_serving.server.page.fairseq.data.legacy.block_pair_dataset import BlockPairDataset
from bert_serving.server.page.fairseq.data.legacy.masked_lm_dataset import MaskedLMDataset
from bert_serving.server.page.fairseq.data.legacy.masked_lm_dictionary import BertDictionary
