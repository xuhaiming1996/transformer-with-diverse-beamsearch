...
from bert_serving.server.page.fairseq.data.legacy.masked_lm_dictionary import MaskedLMDictionary

from bert_serving.server.page.fairseq.data import (
    ConcatDataset,
    data_utils,
    indexed_dataset,
    TokenBlockDataset,
...
from bert_serving.server.page.fairseq.data import Dictionary
from bert_serving.server.page.fairseq.data.legacy.masked_lm_dataset import MaskedLMDataset
from bert_serving.server.page.fairseq.data.multi_corpus_sampled_dataset import MultiCorpusSampledDataset
